...
final class OverlayCompleteIntegrationTests: XCTestCase {
  ...
  func testCompleteSnoozeUserJourney() async throws {
  ...
  func testCompleteJoinMeetingUserJourney() async throws {
  ...
  func testOverlayWithPastEventEdgeCase() async throws {
  ...
  func testOverlayWithMalformedEventData() async throws {
  ...
  func testMultipleSnoozeSequence() async throws {
  ...
  func testOverlayDuringFocusModeChanges() async throws {
  ...
  func testOverlayDuringPreferenceChanges() async throws {
  ...
  func testOverlayRecoveryFromErrors() async throws {
  ...
  func testOverlayAccessibilityBehavior() async throws {
  ...
  func testOverlayResponseiveness() async throws {
