...
final class OverlayManagerComprehensiveTests: XCTestCase {
    ...
    func testOverlayReplacementWhenShowingNew() {
    ...
    func testCountdownTimerStopsOnHide() {
        let futureEvent = TestUtilities.createTestEvent(
    ...
    func testSnoozeFallbackWithoutScheduler() {
        let event = TestUtilities.createTestEvent()
    ...
    func testTimerCleanupOnDeallocation() throws {
        ...
        XCTAssertTrue(try XCTUnwrap(manager?.isOverlayVisible))
    ...
    func testRapidShowHidePerformance() {
